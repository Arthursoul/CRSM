...
# from model.networks.transformer_proto import Transformer
from model.networks.transformer_proto_iter import Transformer
...
class FewShotModel(nn.Module):
    ...
    def forward(self, x, que, get_feature=False):
        if get_feature:
            ...
            x_tot, que_tot = self.transformer(x_tot, que_tot, img_mask, que_mask, query)
